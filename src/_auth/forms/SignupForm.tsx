    ...
    return (
        <Form {...form}>
            <div className='sm:w-420 flex flex-center-center flex-col'>
                ...
                <p className='text-light-3 small-medium md:based-regular'>To use snapgram enter your account details</p>
            
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 flex flex-col gap-1 w-full">
                    <FormField
